...
Hello, besied **ShmelSys** it's me, Vedernikov Vladimir !
    ...
    <foreignObject x="0" y="0" width="100%" height="100%">
        <div xmlns="http://www.w3.org/1999/xhtml" xmlns:xlink="http://www.w3.org/1999/xlink" class="items-wrapper">
                ...
                <div class="row">
                    <section>
                        <h2 class="field">
                            ...
                            28 Repositories (including 13 forks)
                        </h2>
                        <div class="row">
                            <section>
                                <div class="field">
            ...
            <section class="column">
                ...
                <small>estimation from 535kb of code in 527 edited files across 149 commits</small>
                <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="460" height="8">
                    <mask id="languages-bar">
                        <rect x="0" y="0" width="460" height="8" fill="white" rx="5"/>
                    </mask>
                    <rect mask="url(#languages-bar)" x="0" y="0" width="0" height="8" fill="#d1d5da"/>
                    <rect mask="url(#languages-bar)" x="0" y="0" width="321.6041525130809" height="8" fill="#dea584"/>
                    <rect mask="url(#languages-bar)" x="321.6041525130809" y="0" width="73.24823303655499" height="8" fill="#3572A5"/>
                    <rect mask="url(#languages-bar)" x="394.85238554963587" y="0" width="39.49428493104969" height="8" fill="#555555"/>
                    <rect mask="url(#languages-bar)" x="434.3466704806856" y="0" width="11.612257303250258" height="8" fill="#41b883"/>
                    <rect mask="url(#languages-bar)" x="445.95892778393585" y="0" width="4.495774782183765" height="8" fill="#6E4C13"/>
                    <rect mask="url(#languages-bar)" x="450.4547025661196" y="0" width="3.3827963909846126" height="8" fill="#f34b7d"/>
                    <rect mask="url(#languages-bar)" x="453.83749895710423" y="0" width="3.3279698692506643" height="8" fill="#427819"/>
                    <rect mask="url(#languages-bar)" x="457.1654688263549" y="0" width="2.834531173645129" height="8" fill="#ededed"/>
                </svg>
                <div class="field center horizontal-wrap fill-width">
                    ...
                    <div class="field center no-wrap language">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                            <path fill="#427819" fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8z"/>
                        </svg>
                        Makefile
                    </div>
                    <div class="field center no-wrap language">
